...
ServicePurposeS3Static website asset storageCloudFrontGlobal CDN for fast, secure content deliveryRoute 53DNS management and custom domain routingACMSSL/TLS certificate management for HTTPSAPI GatewayREST API endpoint for backend functionalityLambdaServerless compute for backend logicDynamoDBNoSQL data storageSESTransactional email deliveryIAMLeast-privilege roles and permissionsAmazon BedrockClaude 3 Sonnet AI model for chat functionality
...
Enable Amazon Bedrock model access in the AWS Console:
...
Retrieve the live chat API URL:


bash   terraform output chat_api_url
